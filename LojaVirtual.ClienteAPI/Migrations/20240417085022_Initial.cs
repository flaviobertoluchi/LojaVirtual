    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        ...
                        .Annotation("SqlServer:TemporalHistoryTableName", "ClienteTokensHistory")
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClienteTokens", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClienteTokens_Clientes_ClienteId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, true, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Admin", "f98616cf7e22979eb55bb8ccfc5fbaa01a31475f45823b734b8b4c92012b4c5c", "Admin", "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClienteTokens_ClienteId",
                table: "ClienteTokens",
                column: "ClienteId",
                unique: true);
        }
